...
| Download for Mac  | nav, hero, CTA-section | `https://github.com/pacifio/atlas/releases/download/alpha-0.1.7/Atlas_0.1.7_aarch64.dmg` |

The download URL is hard-coded to the alpha-0.1.7 GitHub Release asset.
...
sed -i '' 's|alpha-0.1.7/Atlas_0.1.7_aarch64.dmg|alpha-0.2.0/Atlas_0.2.0_aarch64.dmg|g' landing/index.html
# then update the version label in the hero-meta + cta-tiny lines
sed -i '' 's|v0.1.7|v0.2.0|g' landing/index.html
```
