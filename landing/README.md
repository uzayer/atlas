...
| Download for Mac  | nav, hero, CTA-section | `https://github.com/pacifio/atlas/releases/download/alpha-0.1.4/Atlas_0.1.4_aarch64.dmg` |

The download URL is hard-coded to the alpha-0.1.4 GitHub Release asset.
...
sed -i '' 's|alpha-0.1.4/Atlas_0.1.4_aarch64.dmg|alpha-0.2.0/Atlas_0.2.0_aarch64.dmg|g' landing/index.html
